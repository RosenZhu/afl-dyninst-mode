...
# -I$(TBB_INC) -I/usr/include -I$(LOCAL_INC)  -L$(LOCAL_LIBS)
...
PROGS       = libAFLDyninst AFLDyninst
# SH_PROGS    = afl-plot
...
#COMM_HDR    = config.h debug.h types.h instConfig.h
...
clean:
	rm -f $(PROGS) libAFLDyninst.so AFLDyninst

install:all
	install -m 755 libAFLDyninst.so AFLDyninst ../.
# install: all
